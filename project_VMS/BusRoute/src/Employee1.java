...
public class Employee1 extends JPanel {
...
splashImage = new JLabel(new ImageIcon(ClassLoader.getSystemResource("images/ii1.JPG")));

tablePanel.add(splashImage, BorderLayout.CENTER);
...
btnAddEntry.setBackground(new Color(4, 1, 8));
btnAddEntry.setFont(new Font("monospaced", Font.BOLD, 16));
buttonPanel.add(btnUpdate);
btnUpdate.setForeground(Color.white);
btnUpdate.setBackground(new Color(4, 1, 8));
btnUpdate.setFont(new Font("monospaced", Font.BOLD, 16));
buttonPanel.add(btnRefresh);
btnRefresh.setForeground(Color.white);
btnRefresh.setBackground(new Color(4, 1, 8));
...
btnClose.setBackground(new Color(4, 1, 8));
btnClose.setFont(new Font("monospaced", Font.BOLD, 16));
buttonPanel.setBackground(new Color(245, 202, 40));
taleEmpList.setBackground(new Color(250, 223, 184));

jsp.setBackground(new Color(250, 223, 184));
...
public void actionPerformed(java.awt.event.ActionEvent e) {
NewEntry1 frm = new NewEntry1(taleEmpList.getValueAt(getSelectedRow(), 0).toString(),
...
tablePanel.setBounds(2, 200, 1100, 10);
//add(tablePanel);
}
...
"Date purchased", "Insurance Status", "Date Insured", "Expiry Date", "E-mail", "Address"
};
private Object[][] data = new Object[40][40];

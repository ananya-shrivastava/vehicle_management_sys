...
public class NewEntry1 extends JInternalFrame {
...
private DateButton dobs,dobs1,dobs2;
...
address = new JLabel("Insurance Status");
address.setFont(new Font("monospaced", Font.BOLD, 20));
DOB = new JLabel("Date purchased");
...
txtEmpNo = new JTextField(70);

txtSname = new JTextField(70);
txtSname.setFont(new Font("monospaced", Font.BOLD, 20));
txtSname.setBounds(120, 5,270,32);
txtFname = new JTextField(70);
txtFname.setFont(new Font("monospaced", Font.BOLD, 20));
txtLname = new JTextField(70);
txtLname.setFont(new Font("monospaced", Font.BOLD, 20));
cbogender = new JComboBox();
cbogender.setFont(new Font("monospaced", Font.BOLD, 20));
txtDesignation = new JTextField(70);
txtDesignation.setFont(new Font("monospaced", Font.BOLD, 20));
txttelephone = new JTextField(70);
txttelephone.setFont(new Font("monospaced", Font.BOLD, 20));
txtemail = new JTextField(70);
txtemail.setFont(new Font("monospaced", Font.BOLD, 20));
txtaddress = new JTextField(70);
txtaddress.setFont(new Font("monospaced", Font.BOLD, 20));

dobs = new DateButton();
dobs1 = new DateButton();
dobs2= new DateButton();
...
Update.setBackground(new Color(4, 1, 8));
Update.setFont(new Font("monospaced", Font.BOLD, 16));
Search.setForeground(Color.white);
Search.setBackground(new Color(4, 1, 8));
...
Delete.setBackground(new Color(4, 1, 8));
Delete.setFont(new Font("monospaced", Font.BOLD, 16));
Cancel.setForeground(Color.white);
Cancel.setBackground(new Color(4, 1, 8));
Cancel.setFont(new Font("monospaced", Font.BOLD, 16));
//pics = new JPanel();
//pics.setPreferredSize(new Dimension(150, 250));
//pics.add(lblEmplPic);
jPanel1 = new javax.swing.JPanel(new java.awt.GridLayout(9, 2));
...
" Bus_regno ='" + txtSname.getText() +
"',Model ='" + txtFname.getText() +
"',Capacity ='" + txtLname.getText() +
"',DateBought ='" + dobs1.getText() +
"',Insurance_status ='" + txtaddress.getText() +
"',Date_insured='" + dobs.getText() +
"',Insurance_expiry ='" + dobs2.getText() +
//"',E_Mail ='" + txtemail.getText() +
//"',Address ='" + txtaddress.getText() +
"' WHERE BusNo LIKE'" + txtEmpNo.getText() + "'";
...
int returnVal = fc.showOpenDialog(NewEntry1.this);

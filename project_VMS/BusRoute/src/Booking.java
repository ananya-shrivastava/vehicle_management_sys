...
label.setFont(new Font("monospaced", Font.BOLD, 22));
        ...
        label2.setFont(new Font("monospaced", Font.BOLD, 22));
        label3.setFont(new Font("monospaced", Font.BOLD, 22));
        label4.setFont(new Font("monospaced", Font.BOLD, 22));
        label5.setFont(new Font("monospaced", Font.BOLD, 22));
        label6.setFont(new Font("monospaced", Font.BOLD, 22));
        label7.setFont(new Font("monospaced", Font.BOLD, 22));
        label8.setFont(new Font("monospaced", Font.BOLD, 22));
        label9.setFont(new Font("monospaced", Font.BOLD, 22));
        label10.setFont(new Font("monospaced", Font.BOLD, 22));
        text1.setFont(new Font("monospaced", Font.BOLD, 22));
        text2.setFont(new Font("monospaced", Font.BOLD, 22));
        text3.setFont(new Font("monospaced", Font.BOLD, 22));
        ...
        combo7.setBackground(Color.WHITE);
        combo8.setBackground(Color.WHITE);
        combo9.setBackground(Color.WHITE);
        
        combo1.setFont(new Font("monospaced", Font.BOLD, 20));
        combo2.setFont(new Font("monospaced", Font.BOLD, 20));
        combo3.setFont(new Font("monospaced", Font.BOLD, 20));
        combo4.setFont(new Font("monospaced", Font.BOLD, 20));
        combo5.setFont(new Font("monospaced", Font.BOLD, 20));
        combo6.setFont(new Font("monospaced", Font.BOLD, 20));
        combo7.setFont(new Font("monospaced", Font.BOLD, 20));
        combo8.setFont(new Font("monospaced", Font.BOLD, 20));
        combo9.setFont(new Font("monospaced", Font.BOLD, 20));
...
ok.setBackground(new Color(4, 1, 8));
         ok.setFont(new Font("monospaced", Font.BOLD, 18));
...
general.setBackground(new Color(201, 239, 252));
       controls.setBackground(new Color(201, 239, 252));
        pane.setBackground(new Color(201, 239, 252));
         this.getContentPane().setBackground(new Color(201, 239, 252));
           contents.setBackground(new Color(201, 239, 252));
...
ResultSet rst = DBConnection.getDBConnection().createStatement(
ResultSet.TYPE_SCROLL_INSENSITIVE,
ResultSet.CONCUR_UPDATABLE).executeQuery("SELECT Booking_No,Pass_No FROM BOOKING");

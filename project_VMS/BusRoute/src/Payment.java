...
button4.setBackground(new Color(4, 1, 8));
button4.setFont(new Font("monospaced", Font.BOLD, 16));
...
ResultSet rst = DBConnection.getDBConnection().createStatement(
ResultSet.TYPE_SCROLL_INSENSITIVE,
ResultSet.CONCUR_UPDATABLE).executeQuery("SELECT * FROM Booking ");
while (rst.next()) {
combo1.addItem(rst.getString(2));
combo2.addItem(rst.getString(3));

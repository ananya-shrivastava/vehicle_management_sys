...
public class MDIWindow extends JFrame implements WindowListener {
    ...
    public MDIWindow() {
        ...
        welcome.setForeground(new Color(80, 26, 185));
        ...
        //this.getContentPane().setBackground(new Color(249, 183, 46));
        desktop.setBackground(new Color(245, 226, 226));
        setVisible(true);
    }//Constructor closed
    protected JMenuBar CreateJMenuBar() {
        ...
        mnuOperations.setForeground(new Color(80, 26, 185));
        mnuOperations.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        mnuOperations.setMnemonic('O');
        mnuOperations.setEnabled(false);

        mnuNewuser = new JMenuItem("AddNew User");
        mnuNewuser.setForeground(new Color(80, 26, 185));
        mnuNewuser.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        ...
        mnuExit.setForeground(new Color(80, 26, 185));
        mnuExit.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        ...
        mnuFiles.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        mnuFiles.setForeground(new Color(80, 26, 185));
        mnuFiles.setMnemonic('F');
        mnuFiles.setEnabled(false);

        mnuBuses = new JMenuItem("Buses");
        mnuBuses.setForeground(new Color(80, 26, 185));
        mnuBuses.setEnabled(true);
        mnuBuses.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        ...
        mnuEmps.setForeground(new Color(80, 26, 185));
        mnuEmps.setEnabled(true);
        mnuEmps.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        ...
        mnuRoutes.setForeground(new Color(80, 26, 185));
        mnuRoutes.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        ...
        mnuPassengers = new JMenuItem("Maintanance");
        mnuPassengers.setForeground(new Color(80, 26, 185));
        mnuPassengers.setEnabled(false);
        mnuPassengers.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        ...
        mnuProcesses.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        mnuProcesses.setForeground(new Color(80, 26, 185));
        mnuProcesses.setMnemonic('P');

        mnuScheduling = new JMenuItem("Scheduling");
        mnuScheduling.setEnabled(false);
        mnuScheduling.setForeground(new Color(80, 26, 185));
        mnuScheduling.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        ...
        mnuBooking.setForeground(new Color(80, 26, 185));
        mnuBooking.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        ...
        mnuPayment.setForeground(new Color(80, 26, 185));
        mnuPayment.setEnabled(false);
        mnuPayment.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        ...
        mnuReports.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        mnuReports.setForeground(new Color(80, 26, 185));
        mnuReports.setMnemonic('R');


        mnuBusRpt = new JMenuItem("Bus Report");
        mnuBusRpt.setForeground(new Color(80, 26, 185));
        mnuBusRpt.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        ...
        mnuEmpRpt.setForeground(new Color(80, 26, 185));
        mnuEmpRpt.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        ...
        mnuSchedRpt.setForeground(new Color(80, 26, 185));
        mnuSchedRpt.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        ...
        mnuBookRpt.setForeground(new Color(80, 26, 185));
        mnuBookRpt.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        ...
        mnuTools.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        mnuTools.setForeground(new Color(80, 26, 185));
        mnuTools.setMnemonic('T');

        mnuCalculator = new JMenuItem("Calculator");
        mnuCalculator.setForeground(new Color(80, 26, 185));
        mnuCalculator.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        ...
        mnuNotepad.setForeground(new Color(80, 26, 185));
        mnuNotepad.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        ...
        mnuHelp.setFont(new Font("Comic Sans MS", Font.BOLD, 18));
        mnuHelp.setForeground(new Color(80, 26, 185));
        mnuHelp.setMnemonic('H');

        mnuUsrMannual = new JMenuItem("User Manual");
        mnuUsrMannual.setForeground(new Color(80, 26, 185));
        mnuUsrMannual.setFont(new Font("Comic Sans MS", Font.BOLD, 18));

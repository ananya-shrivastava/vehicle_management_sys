...
public class UpdateRoute extends JInternalFrame {
    ...
    public UpdateRoute(String route, String name, String from, String to,
       ...
       Update.setForeground(Color.white);
        ...
        Search.setFont(new Font("monospaced", Font.BOLD, 18));
        Search.setForeground(Color.white);
        
        
        txtRouteNo.setFont(new Font("monospaced", Font.BOLD, 22));
        txtRouteName.setFont(new Font("monospaced", Font.BOLD, 22));
        txtFrom.setFont(new Font("monospaced", Font.BOLD, 22));
        txtTo.setFont(new Font("monospaced", Font.BOLD, 22)); 
        txtAmount.setFont(new Font("monospaced", Font.BOLD, 22));
        txtDistance.setFont(new Font("monospaced", Font.BOLD, 22));
        ...
        jPanel5.setBackground(new Color(201, 239, 252));

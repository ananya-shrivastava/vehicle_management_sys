...
public class Show_Booked extends JInternalFrame {
    ...
    public Show_Booked() {
        ...
        jScrollPane.setBackground(new Color(245,202,40));
        jTable.setBackground(new Color(245,202,40));
          jPanel1.setBackground(new Color(245,202,40));
           jPanel2.setBackground(new Color(196,249,89));

...
public class AddEntry extends JInternalFrame {
    ...
    public AddEntry() {
        ...
        //this.getContentPane().setBackground(new Color(180, 219, 6));
       ...
       // fieldsPanel.setBackground(new Color(180, 219, 6));
        //buttonPanel.setBackground(new Color(180, 219, 6));
        lblBusNo = new JLabel("  Bus Number ");
        lblRegNo = new JLabel("  Reg Number ");
        lblModel = new JLabel("  Model ");
        lblCapacity = new JLabel("  Capacity ");
        lblDOP = new JLabel("  Date Purchased");
        lblInsuranceStatus = new JLabel("  Ins Status");
        lblDOI = new JLabel("  Date Insured");
        lblDOIE = new JLabel("  Ins Exp-Date");
        ...
        txtBusNo.setFont(new Font("monospaced", Font.BOLD, 20));
        txtRegNo.setFont(new Font("monospaced", Font.BOLD, 20));
        txtModel.setFont(new Font("monospaced", Font.BOLD, 20));
        txtCapacity.setFont(new Font("monospaced", Font.BOLD, 20));
        txtIStatus.setFont(new Font("monospaced", Font.BOLD, 20));
        ...
        date_ins.setFont(new Font("monospaced", Font.BOLD, 20));
        date_bought.setForeground(Color.red);
        date_bought.setFont(new Font("monospaced", Font.BOLD, 20));
         date_expiry.setForeground(Color.red);
         date_expiry.setFont(new Font("monospaced", Font.BOLD, 20));

        fieldsPanel = new JPanel(new GridLayout(8, 2));
        buttonPanel = new JPanel(new FlowLayout());

         btnAddNew.setBackground(new Color(4, 1, 8));
        btnAddNew.setFont(new Font("monospaced", Font.BOLD, 18));
        btnAddNew.setForeground(Color.white);
        
         btnCancel.setBackground(new Color(4, 1, 8));
        btnCancel.setFont(new Font("monospaced", Font.BOLD, 18));
        btnCancel.setForeground(Color.white);
        
         btnClear.setBackground(new Color(4, 1, 8));
        btnClear.setFont(new Font("monospaced", Font.BOLD, 18));
        btnClear.setForeground(Color.white);
        
        //btnNext.setBackground(new Color(4, 1, 8));
        //btnNext.setFont(new Font("monospaced", Font.BOLD, 18));
        //btnNext.setForeground(Color.white);
        
        lblBusNo.setFont(new Font("monospaced", Font.BOLD, 20));
        lblRegNo.setFont(new Font("monospaced", Font.BOLD, 20));
        lblModel.setFont(new Font("monospaced", Font.BOLD, 20));
        lblCapacity.setFont(new Font("monospaced", Font.BOLD, 20));
        lblDOP.setFont(new Font("monospaced", Font.BOLD, 20));
        lblInsuranceStatus.setFont(new Font("monospaced", Font.BOLD, 20));
        lblDOI.setFont(new Font("monospaced", Font.BOLD, 20));
        lblDOIE.setFont(new Font("monospaced", Font.BOLD, 20));
        
        fieldsPanel.setPreferredSize(new Dimension(450, 300));
        ...
        fieldsPanel.setBackground(new Color(201, 239, 252));
        buttonPanel.setBackground(new Color(201, 239, 252));
       
        //jPanel3.add(fieldsPanel, BorderLayout.CENTER);
         //jPanel3.add(buttonPanel, BorderLayout.PAGE_END);
         //jPanel3.setBackground(new Color(180, 219, 6));

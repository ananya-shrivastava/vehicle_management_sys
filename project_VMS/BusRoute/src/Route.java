...
public class Route extends JPanel {
    ...
    public Route() {
        ...
        jTable.setBackground(new Color(250, 223, 184));
        jScrollPane.setBackground(new Color(250, 223, 184));
        
        jButton1.setBackground(new Color(4, 1, 8));
        jButton1.setFont(new Font("monospaced", Font.BOLD, 18));
        ...
        jPanel1.setPreferredSize(new Dimension(750, 350));

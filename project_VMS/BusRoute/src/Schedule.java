...
btnPrint.setBackground(new Color(4, 1, 8));
btnPrint.setFont(new Font("monospaced", Font.BOLD, 16));
Check.setForeground(Color.white);
Check.setBackground(new Color(4, 1, 8));
Check.setFont(new Font("monospaced", Font.BOLD, 16));
...
Schedule.setBackground(new Color(4, 1, 8));
Schedule.setFont(new Font("monospaced", Font.BOLD, 16));
s_date = new DateButton();
cboTrip.addItem("1");
cboTrip.addItem("2");
cboTrip.addItem("3");
//Labels Settings
BusNo.setFont(new Font("sansserif", Font.BOLD, 16));
RegNo.setFont(new Font("sansserif", Font.BOLD, 16));
RouteNo.setFont(new Font("sansserif", Font.BOLD, 16));
RouteName.setFont(new Font("sansserif", Font.BOLD, 16));
DriverNo.setFont(new Font("sansserif", Font.BOLD, 16));
date.setFont(new Font("sansserif", Font.BOLD, 16));
Trip.setFont(new Font("sansserif", Font.BOLD, 16));
DeptTime.setFont(new Font("sansserif", Font.BOLD, 16));
DriverName.setFont(new Font("sansserif", Font.BOLD, 16));
DriverName.setForeground(Color.black);
DeptTime.setForeground(Color.black);
BusNo.setForeground(Color.black);
RegNo.setForeground(Color.black);
RouteNo.setForeground(Color.black);
RouteName.setForeground(Color.black);
DriverNo.setForeground(Color.black);
DriverName.setForeground(Color.black);
date.setForeground(Color.black);
Trip.setForeground(Color.black);
...
cboRouteNo.setBackground(Color.WHITE);
cboBusNo.addItem("Select");
cboBusNo.setBackground(Color.WHITE);
cboRouteName.addItem("Select");
cboRouteName.setBackground(Color.WHITE);
cboDriverNo.addItem("Select");
cboDriverNo.setBackground(Color.WHITE);
cboDriverName.addItem("Select");
cboDriverName.setBackground(Color.WHITE);
cboRegNo.addItem("Select");
cboRegNo.setBackground(Color.WHITE);
cboTrip.setBackground(Color.WHITE);
//Labels Settings
